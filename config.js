...
if (process.env.IS_BUILDING_NEXTJS) {
  ...
  module.exports = envalid.cleanEnv(
    process.env,
    {
      ...
      SERVER_URL: url({ default: 'https://bfm-test-haunguyenniteco.vercel.app' }),
      ...
      SITE_URL: str({ default: 'https://bfm-test-haunguyenniteco.vercel.app' }),

      NEXTAUTH_URL: str({ default: 'https://bfm-test-haunguyenniteco.vercel.app' }),
